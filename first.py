...
from database import db, User, Post, Profile, Conversation, Message
...
from routes.chat import chat_bp as chat
from socket_events import register_events

app = Flask(__name__)
socketio = SocketIO(app, cors_allowed_origins="*")        # ← only change
